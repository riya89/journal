      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className={`text-sm text-[#6c7a5b]/70 dark:text-[#EBDDBF]/70 italic mt-2 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
            A quiet space where your thoughts can breathe in the dark.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-[#2b241c] rounded-xl shadow-md p-6 border border-[#cdd6c0]/30 dark:border-[#5b4a3d]/30 hover:shadow-lg transition-shadow">
              ...
              <p className={`text-[#6c7a5b]/80 dark:text-[#EBDDBF]/80 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
                Open any date and write what stays on your mind.
Let your words settle and your streaks grow naturally.
              </p>
            </div>
...
Set reminders, create small goals, and finish what feels right.
              </p>
            </div>
...
It listens softly, offering calm and clarity when you need it most.
            ...
            <div className="bg-white dark:bg-[#2b241c] rounded-xl shadow-md p-6 border border-[#cdd6c0]/30 dark:border-[#5b4a3d]/30 hover:shadow-lg transition-shadow">
              ...
              <p className={`text-[#6c7a5b]/80 dark:text-[#EBDDBF]/80 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
                Watch your moods take shape over time.
Earn XP, complete quests, and notice your steady rhythm.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-[#2b241c] rounded-xl shadow-md p-6 border border-[#cdd6c0]/30 dark:border-[#5b4a3d]/30 hover:shadow-lg transition-shadow">
              ...
              <p className={`text-[#6c7a5b]/80 dark:text-[#EBDDBF]/80 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
                Add moments that bring light.
Revisit them whenever the world feels too quiet.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-[#2b241c] rounded-xl shadow-md p-6 border border-[#cdd6c0]/30 dark:border-[#5b4a3d]/30 hover:shadow-lg transition-shadow">
              ...
              <p className={`text-[#6c7a5b]/80 dark:text-[#EBDDBF]/80 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
                Write to your future self or the version of you who’s already at peace.
Your words will wait until it’s time to return.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className={`flex gap-3 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
              ...
              <p className="text-[#6c7a5b]/80 dark:text-[#EBDDBF]/80">
                <strong>Be consistent.</strong> A few honest words each day keep your rhythm alive. </p>
            </div>
            <div className={`flex gap-3 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
              <span className="text-[#7A916C] dark:text-[#d4a574] font-bold">•</span>
              <p className="text-[#6c7a5b]/80 dark:text-[#EBDDBF]/80">
                <strong>Explore freely.</strong> Journal, plan, or whisper your gratitude, follow what feels right.
              </p>
            </div>
            <div className={`flex gap-3 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
              <span className="text-[#7A916C] dark:text-[#d4a574] font-bold">•</span>
        ...
        <div className="mt-8 text-center flex items-center justify-center gap-2">
          ...
          <p className={`text-sm text-[#6c7a5b]/70 dark:text-[#EBDDBF]/70 ${theme === 'dark' ? 'font-gothic-body' : ''}`}>
            Made with calm, for the nights you choose to stay with yourself. 
          </p>
        </div>
      </div>
    </div>

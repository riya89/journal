 ...
 */
export const matchOrigin = (request: Request, env: unknown, config: CorsConfig): string | null => {
 ...
 */
export const handlePreflight = (request: Request, env: unknown, config: CorsConfig): Response => {
  const allowedOrigin = matchOrigin(request, env, config);
 ...
 * ```
 */
export const createCorsHandler = (config: CorsConfig): CorsHandler => {
  return (request: Request, env: unknown, response?: Response): Response => {
...
/**
 * CORS handler that disables CORS by not adding any CORS headers.
 * Requests from browsers will be blocked by CORS policy.
 *
 ...
 * ```
 */
export const corsDisabled: CorsHandler = (request: Request, _env: unknown, response?: Response): Response => {
